...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-xl border border-slate-200/80 bg-white text-slate-900 shadow-soft-sm transition-all duration-200',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'text-base font-semibold leading-none tracking-tight text-slate-900 sm:text-lg',
      className
    )}
    {...props}
  />
