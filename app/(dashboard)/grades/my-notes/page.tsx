...
function printBulletin(d: {
  ...
  w.document
    ...
    <div class="head"><div><h1>Kotaschool</h1><div>Système Éducatif · EPSP (RDC)</div></div><div style="text-align:right"><b>Bulletin · ${esc(
      d.semestre
    ...
    <div class="sig">Fait le ${new Date().toLocaleDateString(
      'fr-FR'
    )} — Direction des Études Kotaschool</div>
...
function printAnnualBulletin(
  ...
  w.document
    ...
    <div class="head">
      <div><h1>Kotaschool</h1><div>RÉPUBLIQUE DÉMOCRATIQUE DU CONGO · EPSP</div></div>
