...
export type SessionUser = { id: string; username: string; email?: string | null; role: 'ADMIN' | 'TEACHER' | 'STUDENT'; roleLabel?: string; eleve?: { matricule: string; nom: string; prenom: string } | null };
